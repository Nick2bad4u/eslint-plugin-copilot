...
- [minimal](./minimal.md) — smallest structural baseline
- [recommended](./recommended.md) — balanced default for most repositories
- [strict](./strict.md) — tighter enforcement for mature repos
- [all](./all.md) — every rule the plugin ships
