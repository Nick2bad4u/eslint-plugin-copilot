...
Thanks for using `eslint-plugin-copilot`.
...
2. Search existing issues:
   - <https://github.com/Nick2bad4u/eslint-plugin-copilot/issues>
3. Open a new issue if needed:
   - <https://github.com/Nick2bad4u/eslint-plugin-copilot/issues/new>
