...
- GitHub Security Advisory draft: <https://github.com/Nick2bad4u/eslint-plugin-copilot/security/advisories/new>
...
- Keep `eslint-plugin-copilot`, ESLint, GitHub Copilot tooling, and dependencies updated.
